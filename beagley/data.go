...
var boardInfoMappings = map[string]genericlinux.BoardInformation{
	bbYAi: {
		PinDefinitions: []genericlinux.PinDefinition{
			...
			{Name: "29", DeviceName: "gpiochip2", LineNumber: 15, PwmChipSysfsDir: "", PwmID: -1},
			{Name: "31", DeviceName: "gpiochip2", LineNumber: 17, PwmChipSysfsDir: "", PwmID: -1},
			{Name: "32", DeviceName: "gpiochip2", LineNumber: 16, PwmChipSysfsDir: "", PwmID: -1},
			{Name: "33", DeviceName: "gpiochip2", LineNumber: 18, PwmChipSysfsDir: "", PwmID: -1},
